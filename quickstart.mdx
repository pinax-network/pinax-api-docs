...
The Graph Token API lets you access blockchain token information via a GET request. This guide is designed to help you quickly integrate the Token API into your application. 
...
To make an API request using **cURL**, open your command line and run the following command. Be sure to replace the sample with your actual API key:
